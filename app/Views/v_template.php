...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?=base_url('AdminLTE') ?>/dist/img/logoJaya.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <!-- Add icons to the links using the .nav-icon class
          ...
          <li class="nav-item <?= $menu == 'masterdata' ? 'menu-open' : '' ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('Product')?>" class="nav-link <?= $submenu == 'product' ? 'active' : '' ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Product</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('Category')?>" class="nav-link <?= $submenu == 'category' ? 'active' : '' ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Category</p>
                </a>
              </li>
